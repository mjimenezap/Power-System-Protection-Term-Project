...
% Last Modified by GUIDE v2.5 08-Apr-2020 18:49:55
...
file_dat_event_01 = readtable(file);
...
xlabel('Time (s)');ylabel('Voltage (V)');title('Measured voltage');
